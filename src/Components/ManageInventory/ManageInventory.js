                ...
                inventory.map(inventory => <div key={inventory._id}>
                    ...
                    <div className='shadow px-3 py-3 mt-3 d-flex justify-content-between'>
                        <div><h6>{inventory.name}</h6>
                            ...
                            <button className='button-color '>Delete <svg onClick={() => handleDelete(inventory._id)} xmlns="http://www.w3.org/2000/svg" style={{ width: '30px' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
